...
def create_generator(generator_inputs, generator_outputs_channels, generator_labels):

    if a.if_y and a.model == "model2":
        layers = []

        with tf.variable_scope("encoder_1"):
            generator_inputs = conv_cond_concat(generator_inputs, generator_labels)
        ...
        with tf.variable_scope("decoder_1"):
            input = conv_cond_concat(input, generator_labels)
    ...
    def create_discriminator(discrim_inputs, discrim_targets):
        ...
        if a.if_y and a.model == "model1":
            ...
            with tf.variable_scope("layer_1"):
                input = conv_cond_concat(input, labels)
            ...
            for i in range(n_layers):
                with tf.variable_scope("layer_%d" % (len(layers) + 1)):
                    ...
                    layers[-1] = conv_cond_concat(layers[-1], labels)
            ...
            with tf.variable_scope("layer_%d" % (len(layers) + 1)):
                rectified = conv_cond_concat(rectified, labels)
